#!/bin/bash
# THIS VERSION IS ONLY USED BY THE SCRIPT: submit_ecf_an_means.sh
...
# This version only processes level types that have parameters defined
...
for levtype in "${active_levtypes[@]}"; do
